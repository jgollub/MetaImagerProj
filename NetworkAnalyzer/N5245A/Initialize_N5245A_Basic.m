function [inputBufSize freqs] = Initialize_N5245A_Basic(NAobj, numSweepPoints,fstart,fstop,IFbandInHZ,calfile,power) %Assumes NAobj is already opened
%%!!!!!!!!!!!! setting power power here
%preset analyzer
...
% fprintf(NAobj,'DISPlay:WINDow2:TRACe2:FEED "MeasS21" ')
% %autoscale
