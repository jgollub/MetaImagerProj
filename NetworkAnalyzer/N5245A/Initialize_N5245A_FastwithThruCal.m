function [inputBufSize VNASweepFreqs] = Initialize_N5245A_FastwithThruCal(NAobj, numSweepPoints,fstart,fstop,IFbandInHZ,power, calfile) %Assumes NAobj is already opened
...
%%%%%%%%%%%%%%%%%%%
%%load Cal file 
fprintf(NAobj,'SENS:CORR:CSET:ACT "%s",1',calfile);
query(NAobj,'*OPC?');
