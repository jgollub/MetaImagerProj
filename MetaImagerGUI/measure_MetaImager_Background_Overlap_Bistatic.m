function [ background ] = measure_MetaImager_Background_Overlap_Bistatic(hObject,handles,vobj_switch,vobj_vna, axes1,avg_factor,F,num_switches,num_banks, buffersize, panelA)
...
Nf = length(F);
background = zeros(Nf*num_switches,1);
sc = 0;
